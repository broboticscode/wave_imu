...
float ACCEL_X_MIN = -266;
float ACCEL_X_MAX = 262;
float ACCEL_Y_MIN = -274;
float ACCEL_Y_MAX = 279;
float ACCEL_Z_MIN = -295;
float ACCEL_Z_MAX = 244;
...
float magn_ellipsoid_center[3] = {-182.921, 40.9741, 145.085};
float magn_ellipsoid_transform[3][3] = {{0.981423, 0.00423830, 0.0194357}, {0.00423830, 0.994731, -0.00286792}, {0.0194357, -0.00286792, 0.979096}};
